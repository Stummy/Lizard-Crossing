...
| ▶ | **OWNER rejected the golden look → NEUTRAL daylight** (2026-06-26). Keep the even-exposure + ped-fix; neutralize the warm/golden tint to clean daylight. Concept's "golden hour" SUPERSEDED by owner (see VISUAL_TARGET_SHEET color override). | 2 | run | → lighting-post-artist; verify vs OWNER's neutral, NOT Gemini's golden |
