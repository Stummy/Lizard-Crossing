...
namespace LizardCrossing
{
    ...
    public static class CityReskin
    {
        ...
        static readonly Dictionary<string, Skin> Map = new Dictionary<string, Skin>
        {
            ...
            { "CityGen_LR_Facades",  new Skin("wall_stone",     "wall_normal") },     // building facades
            { "Building_Facade.001", new Skin("wall_stone",     "wall_normal") },
            { "CityGenyellow_stone", new Skin("wall_stone",     "wall_normal") },
            { "CityGensimple_concrete_1", new Skin("granite",   null) },             // building concrete base -> granite cladding
            { "CityGenconcrete.001",      new Skin("granite",   null) },
