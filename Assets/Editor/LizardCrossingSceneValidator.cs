// From the work packet (03_SelfTesting/Unity_Test_Scripts), verbatim.
// NOTE: the Phase 1 world is built at runtime by Bootstrap, so run this
// menu item WHILE IN PLAY MODE for meaningful results.
using UnityEngine;
using UnityEditor;
using System.Linq;
...
public static class LizardCrossingSceneValidator
{
    ...
    public static void ValidatePhase1Scene()
    {
        ...
        if (!Application.isPlaying)
            Debug.LogWarning("World is runtime-built: enter Play Mode before validating, or most checks will fail.");
