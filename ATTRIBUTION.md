...
| Car Kit — taxi/sedan/suv/suv-luxury/van/delivery | NYC vehicles | https://kenney.nl/assets/car-kit | Kenney | **CC0** | Cross-traffic cars/taxi replacing procedural box-car (`Resources/Models/CityKit/Vehicles/*.glb`) |
| City Kit (Roads) — sign-highway-detailed, construction-barrier | NYC signage | https://kenney.nl/assets/city-kit-roads | Kenney | **CC0** | Sidewalk signpost + barrier (`Resources/Models/CityKit/Signage/{sign_post,barrier}.glb`) |
| KayKit City Builder Bits — firehydrant, bench, trash_A/B, dumpster, trafficlight_A/B, streetlight, bush | NYC street furniture | https://github.com/KayKit-Game-Assets/KayKit-City-Builder-Bits-1.0 (also https://kaylousberg.com/game-assets/city-builder-bits) | Kay Lousberg | **CC0** | Hydrant, bench, trash cans, dumpster, traffic light, street lamp, planter bush (`Resources/Models/CityKit/Furniture/*.gltf`) |
